	...
	<view class="bbl-content">
		<view class="uni-padding-wrap uni-common-mt">
		            <view class="bbl-content_video">
						...
						>
						<!--顶部栏 竖屏-->
						<view class="video-control" v-if="isMenu" @tap.stop>
						...
						<!--右侧播放速度菜单 竖屏-->
						<view class="video-heizith-menu" v-if="!isFullScree">
							<view class="video-control-item" @tap.native.stop="showSwitchRate">x {{currentRate}}</view>
							<!-- <view class="video-control-item">x {{currentRate}}</view> -->
						</view>
						<!--全屏左侧锁定-->
						...
						<view class="video-control-bottom" v-if="isMenu&&!isFullScree" @tap.native.stop>
							...
							<!--时间区域-->
							<view class="video-control-bottom-time">
								{{currtime}}/{{druation}}
							</view>
							<!--进度条区域-->
							<view class="video-control-bottom-bar" :style="[{width:dotBaseWidth +'rpx'}]">
								...
								<view class="video-control-bottom-bar-gray">
									<!--动态有进度进度条区域-->
									<view class="video-control-bottom-bar-color" 
									:style="[{width:dotSlide + 'rpx'}]"></view>
								</view>
								<view class="video-control-bottom-bar-dot" 
						...
						<view class="video-control-bottom" v-if="isMenu&&isFullScree" @tap.stop>
							...
							<!--进度条区域-->
							<view class="video-control-bottom-bar" 
							...
							<view class="video-fullScree-speed" @tap.native.stop="showSwitchRate">x {{currentRate}}</view>
							<!--全屏按钮区域-->
